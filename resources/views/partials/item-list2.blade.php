<div class="container">
    ...
    <div class="row>">
        <table class="table table-bordered table-sm table-condensed table-striped table-hover items-table" id="item-table2">
            <thead>
            <tr>
                <th>Store</th>
                <th>UPC/PLU</th>
            ...
            @foreach($items as $item)
                <tr id="item_{{$item->id}}" class="sales-tr" data-toggle="modal" data-target="#itemmodal_{{ $item->id }}">
